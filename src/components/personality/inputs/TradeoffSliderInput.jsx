  ...
  return (
    <fieldset className="tradeoff-input w-full" role="group" aria-label="Select tradeoff level">
      ...
      <div className="flex flex-col items-center gap-6 w-full mt-6">
        ...
        <div
          className="relative flex items-center w-full max-w-xl h-4 bg-gray-200 dark:bg-gray-700 rounded-full cursor-pointer focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500"
