      ...
      <div className="flex flex-col gap-3 mt-4">
        {choices.map((choice) => (
          <label
            ...
            className={`flex flex-col justify-center p-4 rounded-xl cursor-pointer border-2 focus-visible:ring-2 focus-visible:ring-axim-primary/50 transition-all min-h-[60px]
              ${value === choice.value
