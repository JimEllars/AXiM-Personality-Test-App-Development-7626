        ...
        <div className="flex justify-between w-full max-w-lg gap-2">
          {choices.map((choice) => (
            <label
              ...
              className={`flex flex-col items-center justify-center p-2 rounded-lg cursor-pointer focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-2 min-h-[44px] min-w-[44px] transition-all
                ${value === choice.value
