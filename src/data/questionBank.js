...
const definitions = {
  Ti: [
    ...
    { type: 'tradeoff', prompt: 'When listening to an argument...', options: { left: 'I care if the logic is perfectly sound', right: 'I care if it sounds good' }, reverseScored: false, a: 1.30 },
    { type: 'reaction', prompt: 'Someone says "It just works, do not overthink it!"', context: '', options: { choices: [{ label: 'Question it', description: 'Figure out WHY it works', value: 1 }, { label: 'Accept it', description: 'Move on', value: 5 }] }, reverseScored: true, a: 1.52 },
  ...
  Te: [
    ...
    { type: 'tradeoff', prompt: 'When things get chaotic...', options: { left: 'I enforce structure and order', right: 'I go with the flow' }, reverseScored: false, a: 1.34 },
    { type: 'reaction', prompt: 'A deadline is approaching but the group lacks consensus.', context: '', options: { choices: [{ label: 'Execute', description: 'Make a call and move forward', value: 1 }, { label: 'Delay', description: 'Wait for everyone to agree', value: 5 }] }, reverseScored: true, a: 1.48 },
  ...
  Fi: [
    ...
    { type: 'tradeoff', prompt: 'My principles are...', options: { left: 'Deeply held and unchanging', right: 'Flexible based on the situation' }, reverseScored: false, a: 1.58 },
    { type: 'reaction', prompt: 'Someone acts fake to impress others.', context: '', options: { choices: [{ label: 'Cringe', description: 'It feels instantly wrong in my gut', value: 1 }, { label: 'Understand', description: 'Everyone does it', value: 5 }] }, reverseScored: true, a: 1.44 },
  ...
  Fe: [
    ...
    { type: 'tradeoff', prompt: 'When someone is upset...', options: { left: 'I instantly pick up on the awkward tension', right: 'I barely notice' }, reverseScored: false, a: 1.47 },
    { type: 'reaction', prompt: 'You have to deliver bad news.', context: '', options: { choices: [{ label: 'Soften it', description: 'Adjust my tone carefully', value: 1 }, { label: 'Be blunt', description: 'Just say the facts', value: 5 }] }, reverseScored: true, a: 1.62 },
  ...
  Ni: [
    ...
    { type: 'tradeoff', prompt: 'My goals are usually...', options: { left: 'A single, unifying vision', right: 'Scattered and changing' }, reverseScored: false, a: 1.39 },
    { type: 'reaction', prompt: 'Someone asks you where you see yourself in 10 years.', context: '', options: { choices: [{ label: 'Clear picture', description: 'I have a strong gut feeling', value: 1 }, { label: 'No idea', description: 'That is too far away', value: 5 }] }, reverseScored: true, a: 1.51 },
  ...
  Ne: [
    ...
    { type: 'tradeoff', prompt: 'My thought process is usually...', options: { left: 'Bouncing wildly between unrelated concepts', right: 'Linear and focused' }, reverseScored: false, a: 1.46 },
    { type: 'reaction', prompt: 'Someone shares a bizarre, totally hypothetical idea.', context: '', options: { choices: [{ label: 'Engage', description: 'I love playing with concepts', value: 1 }, { label: 'Dismiss it', description: 'It has no use', value: 5 }] }, reverseScored: true, a: 1.37 },
  ...
  Si: [
    ...
    { type: 'tradeoff', prompt: 'When solving a problem...', options: { left: 'I rely on detailed past experiences', right: 'I ignore precedent' }, reverseScored: false, a: 1.38 },
    { type: 'reaction', prompt: 'Someone asks you about a past event.', context: '', options: { choices: [{ label: 'Precise', description: 'I remember exactly what happened', value: 1 }, { label: 'Vague', description: 'I just remember the vibe', value: 5 }] }, reverseScored: true, a: 1.45 },
  ...
  Se: [
    ...
    { type: 'tradeoff', prompt: 'When physical conditions change...', options: { left: 'I adapt my actions instantly', right: 'I hesitate' }, reverseScored: false, a: 1.49 },
    { type: 'reaction', prompt: 'An opportunity physically appears near you.', context: '', options: { choices: [{ label: 'Grab it', description: 'I notice things as soon as they appear', value: 1 }, { label: 'Miss it', description: 'I was lost in thought', value: 5 }] }, reverseScored: true, a: 1.39 },
